...
public class LeafModel extends SkullBlockEntityModel {
    public static final EntityModelLayer LAYER = new EntityModelLayer(NyctoPlus.id("leaf"), "main");
    ...
    public static TexturedModelData getTexturedModelDataLeaf() {
