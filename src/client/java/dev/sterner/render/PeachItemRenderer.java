...
public class PeachItemRenderer implements BuiltinItemRendererRegistry.DynamicItemRenderer {
    ...
    public void render(ItemStack stack, ModelTransformationMode mode, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        SkullBlockEntityModel skullBlockEntityModel = new SkullEntityModel(MinecraftClient.getInstance().getEntityModelLoader().getModelPart(EntityModelLayers.PLAYER_HEAD));
        RenderLayer renderLayer = PeachBlockEntityRenderer.getRenderLayer(gameProfile);
        PeachBlockEntityRenderer.renderSkull(null, 180.0F, matrices, vertexConsumers, light, skullBlockEntityModel, renderLayer);
    }
}
